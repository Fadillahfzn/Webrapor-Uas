                   ...
                   <div class="row">
                    <div class="col-xl-12">
                        <div class="card shadow-mb-4">
                            ...
                            <div class="card-body">
                                <form action="{{ route('tambahsiswa.store') }}" class="card" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="input-placeholder">NISN(*)</label>
                                                <input type="text" name="nisn" id="name" class="form-control" autocomplete="off" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="input-placeholder">Username(*)</label>
                                                <input type="text" name="username" id="name" class="form-control" autocomplete="off" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="input-placeholder">Password(*)</label>
                                                <input type="password" name="password" id="name" class="form-control" autocomplete="off" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
