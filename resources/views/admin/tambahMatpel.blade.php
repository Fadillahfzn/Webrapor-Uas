                   ...
                   <div class="row">
                    <div class="col-xl-12">
                        <div class="card shadow-mb-4">
                            ...
                            <div class="card-body">
                                <form action="{{ route('tambahmatpel.store') }}" class="card" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="input-placeholder">Kode Matpel</label>
                                                <input type="text" name="kd_mapel" id="kd_mapel" class="form-control" autocomplete="off" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="input-placeholder">KKM</label>
                                                <input type="number" name="angka" id="angka" class="form-control" autocomplete="off" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
